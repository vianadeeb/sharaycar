        ...
        const images = [
            {
                ...
                original: require('../assets/img/motorcycles.jpg'),
                thumbnail:require('../assets/img/motorcycles.jpg') ,
            },
            {
                original: require('../assets/img/motorcycles1.jpg'),
                thumbnail: require('../assets/img/motorcycles1.jpg') 
            },
            {
                original: require('../assets/img/motorcycles.jpg'),
                thumbnail: require('../assets/img/motorcycles.jpg') 
            ...
            <div>
                ...
                <div id="imgg">
                    <Row id="imgc" style={{ marginRight: 0 }}>
                        <Col>
                            <ImageGallery items={images} id="itemimg" />
                        </Col>
                    </Row>
                </div>
                <div id="trans">
